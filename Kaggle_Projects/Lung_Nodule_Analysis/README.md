...
- 資料來源說明  
  ...
  資料來源和描述與結節模型相同，需要用到結節資料，不同的是這次在影像上需要做更多的處理。  
...
- 訓練結果  
  ...
  所以就以此作為結節影像分割之模型。  
  <img src="./imgs/2_tb_loss.png" width="50%">  
  可以看出訓練損失下降，但驗證損失卻只有緩慢下降。
  <img src="./imgs/2_tb_per.png" width="50%">
  <img src="./imgs/2_tb_pr.png" width="50%">
  模型訓練時預測之結節分割圖，分別為第1、15、30，可以看出第一次預測幾乎為整個範圍
  <img src="./imgs/2_tb_img1.png" width="50%">
  <img src="./imgs/2_tb_img15.png" width="50%">
  <img src="./imgs/2_tb_img30.png" width="50%">  
